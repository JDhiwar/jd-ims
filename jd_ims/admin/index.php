...
<body>
    ...
    <nav class="leftNav v-res-nav" id="rightNav">
        <li>
            <a href="index.php" class="active"><img src="img/admin.png" alt="" class="nav-logo"><span>Admin</span></a>
        </li>
        <li>
            <a href="../user/index.php"><img src="img/person.png" alt="" class="nav-logo"><span>User</span></a>
        </li>
